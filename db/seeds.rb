...
cards = Card.create!([
{title: "September", user: users[0], lyrics:
...
{title: "Bright Lights", user: users[1], lyrics:
"She got out of town
...
{title: "A Thousand Miles", user: users[2], lyrics:
...
{title: "Unforgettable", user: users[3], lyrics:
"Unforgettable
In every way,
And forever more
...
{title: "Every Time You Say Goodbye", user: users[4], lyrics:
...
{title: "Angel", user: users[5], lyrics:
...
{title: "Witchcraft", user: users[6], lyrics:
...
{title: "I Really Really Really Really Really Really Like You", user: users[7], lyrics:
"I really wanna stop
...
{title: "I Knew You Were Trouble", user: users[8], lyrics:
...
{title: "Breakeven", user: users[9], lyrics:
