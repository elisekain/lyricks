...
cards = Card.create!([
{title: "September", user: users[0], icon_selection: "heart", lyrics:
...
{title: "Bright Lights", user: users[1], icon_selection: "disk", lyrics:
"She got out of town
...
{title: "A Thousand Miles", user: users[2], icon_selection: "headphones", lyrics:
...
{title: "Unforgettable", user: users[3], icon_selection: "music", lyrics:
"Unforgettable
In every way,
And forever more
...
{title: "Every Time You Say Goodbye", user: users[4], icon_selection: "star", lyrics:
...
{title: "Angel", user: users[5], icon_selection: "heart", lyrics:
...
{title: "Witchcraft", user: users[6], icon_selection: "disk", lyrics:
...
{title: "I Really Really Really Really Really Really Like You", user: users[7], icon_selection: "bolt", lyrics:
"I really wanna stop
...
{title: "I Knew You Were Trouble", user: users[8], icon_selection: "headphones", lyrics:
...
{title: "Breakeven", user: users[9], icon_selection: "star", lyrics:
